...
function gameEnd(e) {
    ...
    if(e) {
        gId("rT").innerText = "Influenceren overlevde!"
        gId("rM").innerHTML = "Gratulerer du reddet et liv!<br/><br/>Bra jobba!"
    } else {
        gId("rT").innerText = "Influenceren ble hengt!"
        gId("rM").innerHTML = "Ordet var <br/><br/>\"" + word[select][0].toUpperCase() + "\"<br/><br/>Bedre lykke neste gang!."
    }
    d.className = ""
}
